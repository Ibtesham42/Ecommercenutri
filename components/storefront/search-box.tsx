    ...
    <div ref={rootRef} className="relative w-full">
      ...
      >
        ...
        <Input
          ...
          className="h-12 rounded-full border-input bg-background pl-11 pr-11 text-sm text-foreground shadow-elev-1 transition-[box-shadow,border-color] placeholder:text-muted-foreground/80 focus-visible:border-primary/40 focus-visible:shadow-elev-2 focus-visible:ring-4 focus-visible:ring-primary/15"
          autoFocus={autoFocus}
