  ...
  return (
    <>
      <button
        ...
        onClick={openDialog}
        className={cn(
          "flex items-center gap-1.5 rounded-full px-2.5 py-1.5 text-xs text-surface-deep-foreground/80 transition-colors hover:bg-white/10 hover:text-surface-deep-foreground",
          className,
        )}
      ...
      >
        ...
        <span className="truncate">
          Deliver to{" "}
          <span className="font-semibold text-surface-deep-foreground">{label}</span>
        </span>
